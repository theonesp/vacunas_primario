...
ggsave(
  "/opt/datos_compartidos/vacunas_data/figuras/forest_hospstay_infections_gam.jpeg",
  device = "jpeg",
  units = "px",
  dpi = 300,
  width = 4000,
...
# Saving the plot
ggsave(
  "/opt/datos_compartidos/vacunas_data/figuras/hosp_stay_probability.jpeg",
  device = "jpeg",
  units = "px",
  dpi = 300,
  width = 4000,
...
logreg_icu_stay_bin <- 
  glm(
    icu_stay_bin ~ age + n_vacunas_covid + desc_sexo + variant_period + 
      asma + cardiopatia_isquemica + cirrosis_hepatica + diabetes + epoc +  hepatopatia_cronica_excepto_cirrosis + 
      hipertension + insuficiencia_cardiaca + insuficiencia_renal_cronica + vih + cancer_hematologico + 
      cancer_organo_solido + n_prev_infecc + ultima_inmun_infecc_bin,
    data = train_data,
...
aa <- extract_coef_pval_OR(logreg_icu_stay_bin)
...
# Save the last forest plot rendered
ggsave(
  "/opt/datos_compartidos/vacunas_data/figuras/forest_icustay_infections_gam3.jpeg",
  device = "jpeg",
  units = "px",
  dpi = 300,
  width = 4000,
...
ggplot(df, aes(x = x, y = fit_chance)) +
  geom_ribbon(aes(ymin = lower_bound_chance, ymax = upper_bound_chance), fill = "#2980b9", alpha = 0.3) +
  geom_line() +
  labs(x = "Age", y = "Probability of ICU Admission (%)") +
  ylim(0, 100) + 
  xlim(14,120) +
  theme_minimal()
...
# Saving the plot
ggsave(
  "/opt/datos_compartidos/vacunas_data/figuras/icu_stay_probability.jpeg",
  device = "jpeg",
  units = "px",
  dpi = 300,
  width = 4000,
...
# Save the last forest plot rendered
ggsave(
  "/opt/datos_compartidos/vacunas_data/figuras/forest_mortality_infections_gam.jpeg",
  device = "jpeg",
  units = "px",
  dpi = 300,
  width = 4000,
...
ggplot(df, aes(x = x, y = fit_chance)) +
  geom_ribbon(aes(ymin = lower_bound_chance, ymax = upper_bound_chance), fill = "#2980b9", alpha = 0.3) +
  geom_line() +
  labs(x = "Age", y = "Probability of Mortality (%)") +
  ylim(0, 100) + 
  xlim(14,120) +
  theme_minimal()
...
# Saving the plot
ggsave(
  "/opt/datos_compartidos/vacunas_data/figuras/moratlity_probability.jpeg",
  device = "jpeg",
  units = "px",
  dpi = 300,
  width = 4000,
