...
# Table 2B: Características de la población incluida en el estudio, en total y estratificada según mortalidad en los 30 días posteriores a la PCR positiva (no/sí).

```{r}
table2b<-estudio_vacunas_t_final_selected %>%
  select(
    -c(
      age,
      cod_municipio,
...
table2b
write.csv(table2b,'/opt/datos_compartidos/vacunas_data/tablas/table2b',col.names = F)
