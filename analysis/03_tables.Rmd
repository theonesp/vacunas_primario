...
estudio_vacunas_t_final_selected <-
  readRDS("/opt/datos_compartidos/vacunas_data/Rfiles/estudio_vacunas_t_final_selected.rds")
...
estudio_vacunas_t_final_selected %>%
  select(
    -c(
      ...
      cancer_colorrectal:cancer_inmunoproliferativo,
...
# Tabla 2B: Características de la población incluida en el estudio, en total y estratificada según mortalidad en los 30 días posteriores a la PCR positiva (no/sí).
