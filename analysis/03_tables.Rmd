...
class(estudio_vacunas_t_final_selected$estancia_hospitalaria_dias)
...
```{r}
vars_in_table1<-names(estudio_vacunas_t_final_selected %>% select(desc_sexo, age_num, asma, cardiopatia_isquemica,
                                                                  cirrosis_hepatica, diabetes, epoc,
                                                                  hepatopatia_cronica_excepto_cirrosis, hipertension,
                                                                  insuficiencia_cardiaca, insuficiencia_renal_cronica,
                                                                  cancer_organo_solido, cancer_hematologico, vih,
                                                                  infecc_covid_num, pautas_covid, estancia_hospitalaria_dias,
                                                                  hosp_stay_bin, icu_stay_bin, covid_first_name,
                                                                  # covid_first_date, 
                                                                  covid_full_name,
                                                                  # covid_full_date,
                                                                  cancer_organo_solido, cancer_hematologico, mortality30d))
