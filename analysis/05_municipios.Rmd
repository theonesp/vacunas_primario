...
```{r}
estudio_vacunas_t_final_selected <- readRDS("/opt/datos_compartidos/vacunas_data/Rfiles/estudio_vacunas_t_final_selected_full.rds")
```
...
```{r}
write.csv(municipio_aggregated,'municipio_aggregated_full_dataset.csv',row.names = F)
```
