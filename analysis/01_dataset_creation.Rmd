...
# ALVARO: to consider whether each comorbidity was diagnosed prior to the infection, one must start by not executing the last code line (otherwise, date info will be lost). Check RMarkdown "01b..." to see the proposed alternative.
```
