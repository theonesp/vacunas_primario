...
# ALVARO: to consider whether each comorbidity was diagnosed prior/after the infection, one must start by not executing the last code line (otherwise, date info will be lost).
```
