...
```{r}
resultados_pruebas_COVID_t <- fread("/opt/datos_compartidos/vacunas_data/total/ENC_VACUNAS_TEST_COVID.txt",header = T,encoding = 'UTF-8')

resultados_pruebas_COVID_t$FECHA_MUESTRA<-as.Date(as.character(resultados_pruebas_COVID_t$FECHA_MUESTRA),format="%d/%m/%Y")
