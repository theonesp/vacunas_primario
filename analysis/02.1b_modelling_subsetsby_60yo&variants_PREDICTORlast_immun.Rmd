...
write_excel_csv(
  df_OR_hospitalisation_subgroups,
  file = "/opt/datos_compartidos/vacunas_data/tablas/OR_hospitalisation_subgroups_timesincelastinmun2.xls"
)
```
...
write_excel_csv(
  df_OR_intensivecare_subgroups,
  file = "/opt/datos_compartidos/vacunas_data/tablas/OR_intensivecare_subgroups_timesincelastinmun2.xls"
)
```
...
write_excel_csv(
  df_OR_intensivecare_only_hosp_subgroups,
  file = "/opt/datos_compartidos/vacunas_data/tablas/OR_intensivecare_only_hosp_subgroups_timesincelastinmun.xls"
)
```
...
write_excel_csv(
  df_OR_mortality_subgroups,
  file = "/opt/datos_compartidos/vacunas_data/tablas/OR_mortality_subgroups_timesincelastinmun2.xls"
)
```
