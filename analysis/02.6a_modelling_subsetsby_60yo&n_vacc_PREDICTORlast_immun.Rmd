...
subsetting <- function(data, choose_agegroup, choose_vacc) {
  output <- data %>% 
    ...
    mutate(across(
      c(age_fct_60years, n_vacunas_covid), droplevels
    ))
  return(output)
}
...
# write_excel_csv(
#   df_OR_hospitalisation_subgroups,
#   file = "/opt/datos_compartidos/vacunas_data/tablas/groups2 by nvaccines & agegroup (logreg lastimmun only)/OR_hospitalisation_subgroups_nvacc_PREDICTORtimesincelastvac2.xls"
# )
...
# write_excel_csv(
#   df_OR_intensivecare_subgroups,
#   file = "/opt/datos_compartidos/vacunas_data/tablas/groups2 by nvaccines & agegroup (logreg lastimmun only)/OR_intensivecare_subgroups_nvacc_PREDICTORtimesincelastvac2.xls"
# )
...
# write_excel_csv(
#   df_OR_mortality_subgroups,
#   file = "/opt/datos_compartidos/vacunas_data/tablas/groups2 by nvaccines & agegroup (logreg lastimmun only)/OR_mortality_subgroups_nvacc_PREDICTORtimesincelastvac2.xls"
# )
