...
ggsave("/opt/datos_compartidos/vacunas_data/figuras/coef_pval_df_hosp_stay_bin.png", width = 6, height = 4, dpi = 300)
```
...
print('glm')
print(Sys.time())
logreg_icu_stay_bin <- glm(icu_stay_bin ~ DESC_SEXO+ age+ asma +cardiopatia.isquemica + cirrosis.hepatica + diabetes + epoc + hepatopatia.cronica.excepto.cirrosis + hipertension + insuficiencia.cardiaca + insuficiencia.renal.cronica + cancer_organo_solido + cancer_hematologico + vih + infecc_covid_num + pautas_covid, data =  estudio_vacunas_t_final_selected,family=binomial() )
print(Sys.time())
```
## Odds ratio
