...
logreg_hosp_stay_bin <- glm(
  hosp_stay_bin ~ age_num_decada + desc_sexo + asma + cardiopatia_isquemica + cirrosis_hepatica + diabetes + epoc + hepatopatia_cronica_excepto_cirrosis + hipertension + insuficiencia_cardiaca + insuficiencia_renal_cronica + vih + cancer_hematologico + cancer_organo_solido + pautas_covid + infecc_covid_num,
...
logreg_icu_stay_bin <- glm(
  icu_stay_bin ~ age_num_decada + desc_sexo + asma + cardiopatia_isquemica + cirrosis_hepatica + diabetes + epoc + hepatopatia_cronica_excepto_cirrosis + hipertension + insuficiencia_cardiaca + insuficiencia_renal_cronica + vih + cancer_hematologico + cancer_organo_solido + pautas_covid + infecc_covid_num,
  data =  estudio_vacunas_t_final_selected, 
  family=binomial() )
print(Sys.time())
```
...
logreg_mortality <- glm(
  mortality ~ age_num_decada + desc_sexo + asma + cardiopatia_isquemica + cirrosis_hepatica + diabetes + epoc + hepatopatia_cronica_excepto_cirrosis + hipertension + insuficiencia_cardiaca + insuficiencia_renal_cronica + vih + cancer_hematologico + cancer_organo_solido + pautas_covid + infecc_covid_num,
 data =  estudio_vacunas_t_final_selected,
 family=binomial())
print(Sys.time())
```
