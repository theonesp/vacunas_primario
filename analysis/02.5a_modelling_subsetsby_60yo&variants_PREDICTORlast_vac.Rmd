...
subsetting <- function(data, choose_agegroup, choose_variant) {
  output <- data %>% 
    ...
    mutate(across(
      c(age_fct_60years, variant_period), droplevels
    ))
  return(output)
}
...
# write_excel_csv(
#   df_OR_hospitalisation_subgroups,
#   file = "/opt/datos_compartidos/vacunas_data/tablas/groups2 by variant & agegroup (logreg lastvac only)/OR_hospitalisation_subgroups_timesincelastvacnewgroups.xls"
# )
...
# write_excel_csv(
#   df_OR_intensivecare_subgroups,
#   file = "/opt/datos_compartidos/vacunas_data/tablas/groups2 by variant & agegroup (logreg lastvac only)/OR_intensivecare_subgroups_timesincelastvacnewgroups.xls"
# )
...
# write_excel_csv(
#   df_OR_mortality_subgroups,
#   file = "/opt/datos_compartidos/vacunas_data/tablas/groups2 by variant & agegroup (logreg lastvac only)/OR_mortality_subgroups_timesincelastvacnewgroups.xls"
# )
