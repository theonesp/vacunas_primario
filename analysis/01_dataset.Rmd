...
```{r}
print(Sys.time())
estudio_vacunas_t_final <- Reduce(function(...) merge(..., all=TRUE), list(
  poblacion_diana
  , infect_COVID_first
  , pupa_opt
  , infect_COVID_num  
...
```{r}
print('Número pacientes inicial')
...
```{r}
saveRDS(estudio_vacunas_t_final_selected, file = "/opt/datos_compartidos/vacunas_data/Rfiles/estudio_vacunas_t_final_selected_full.rds")
