...
vacunas_t_covid_full <- vacunas_t %>%
  filter(vac_infecc_umbral >= 14) %>% # los dias entre la vacunacion e infeccion han de ser >= 14
  # ALVARO SERRANO: la linea anterior la introduzco el dia 22/02. Al no estar en el codigo previamente, -->
  ...
  # mas, basados en estos datos. Seguramente sea asi, pero los resultados hechos con el codigo anterior -->
...
estudio_vacunas_t_final_selected %>% 
  ...
  mutate(
    ...
    covid_first_name = replace_na(covid_first_name, "No vacunado", covid_first_name),
    ...
    covid_full_name = replace_na(covid_full_name, "No vacunado o vacunado con menos de tres dosis", covid_full_name),
