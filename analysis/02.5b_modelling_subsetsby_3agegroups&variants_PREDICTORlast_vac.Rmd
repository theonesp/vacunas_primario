...
for (i in seq_along(sub_hosp_list)) {
  output <- sub_hosp_list[[i]] %>%
    filter(str_detect(predictor, "ultima_vac"))
...
# write_excel_csv(
#   df_OR_hospitalisation_subgroups,
#   file = "/opt/datos_compartidos/vacunas_data/tablas/groups3 by variant & agegroup (logreg lastvac only)/OR_hospitalisation_subgroups_timesincelastvacnewgroups.xls"
# )
...
# write_excel_csv(
#   df_OR_intensivecare_subgroups,
#   file = "/opt/datos_compartidos/vacunas_data/tablas/groups3 by variant & agegroup (logreg lastvac only)/OR_intensivecare_subgroups_timesincelastvacnewgroups.xls"
# )
...
# write_excel_csv(
#   df_OR_mortality_subgroups,
#   file = "/opt/datos_compartidos/vacunas_data/tablas/groups3 by variant & agegroup (logreg lastvac only)/OR_mortality_subgroups_timesincelastvacnewgroups.xls"
# )
