...
subsetting <- function(data, choose_variant, choose_agegroup) {
  output <- data %>% 
    ...
    mutate(across(
      c(variant_period, age_fct_3groups), droplevels
    ))
  return(output)
}
...
# write_excel_csv(
#   df_OR_hospitalisation_subgroups,
#   file = "/opt/datos_compartidos/vacunas_data/tablas/groups2 by variant & agegroup (logreg nvaccines only)/OR_hospitalisation_subgroups_n_vacunas.xls"
# )
...
# write_excel_csv(
#   df_OR_intensivecare_subgroups,
#   file = "/opt/datos_compartidos/vacunas_data/tablas/groups2 by variant & agegroup (logreg nvaccines only)//OR_intensivecare_subgroups_n_vacunas.xls"
# )
...
# write_excel_csv(
#   df_OR_mortality_subgroups,
#   file = "/opt/datos_compartidos/vacunas_data/tablas/groups2 by variant & agegroup (logreg nvaccines only)/OR_mortality_subgroups_n_vacunas.xls"
# )
